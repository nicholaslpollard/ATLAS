...
_EXPECTED_METADATA_SIGNATURES = (
    ("0000036377", "0001558370-19-009110", "2019-09-30", "2019-07-01", 0.56, "10-Q", "2019-10-25", "10-Q", "2019-10-24"),
    ("0000079282", "0001564590-20-034396", "2020-06-30", "2020-04-01", 0.34, "10-Q", "2020-07-30", "10-Q", "2020-07-29"),
    ("0000319201", "0000319201-20-000047", "2020-06-30", "2020-04-01", 2.63, "10-K", "2020-08-10", "10-K", "2020-08-07"),
    ("0000912093", "0000912093-16-000032", "2015-03-28", "2014-12-28", -0.06, "10-Q", "2016-08-26", "10-Q/A", "2016-08-26"),
    ("0000912093", "0000912093-16-000032", "2016-04-02", "2016-01-03", 0.14, "10-Q", "2016-08-26", "10-Q/A", "2016-08-26"),
    ("0001173313", "0001213900-17-005701", "2015-12-31", "2015-10-01", -0.02, "10-Q", "2017-05-22", "10-Q/A", "2017-05-22"),
)
...
def _metadata_signature(row: dict[str, Any]) -> tuple[object, ...]:
    companyfacts = row.get("companyfacts_row")
    if not isinstance(companyfacts, dict):
        raise EarningsInnovationCloseoutError("diagnostic Company Facts contradiction row is malformed")
    return (
        str(row.get("issuer_cik") or ""),
        str(row.get("accession_number") or ""),
        str(companyfacts.get("end") or ""),
        str(companyfacts.get("start") or ""),
        float(companyfacts.get("val")),
