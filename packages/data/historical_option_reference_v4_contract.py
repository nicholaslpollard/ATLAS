...
HISTORICAL_OPTION_REFERENCE_V4_CONTRACT = "atlas-historical-option-reference-v4"
...
SAME_CORRECTION_CONFLICT_POLICY = (
    "FAIL_CLOSED_EXCEPT_NARROW_PREEXPIRATION_REFERENCE_IDENTITY_RESOLUTION"
)
    ...
    payload: dict[str, object] = {
        ...
        "normalization": {
            ...
            "narrow_conflict_fallback": {
                ...
                "stock_reference_not_runtime_authority": True,
                "external_corroboration_not_runtime_authority": True,
...
HISTORICAL_OPTION_REFERENCE_V4_CONTRACT_FINGERPRINT = _stable_hash(
