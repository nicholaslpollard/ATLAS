...
HISTORICAL_OPTION_REFERENCE_V7_CONTRACT = "atlas-historical-option-reference-v7"
...
ARTC_DIAGNOSTIC_CONTRACT_FINGERPRINT = (
...
UNVERSIONED_DELIVERABLE_CFI_POLICY = (
    "PREEXPIRATION_EXACT_MATCH_UNVERSIONED_CASH_DELIVERABLE_CLASSIFICATION"
)
...
KNOWN_CONFLICTS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "diagnostic_contract_fingerprint": ARTC_DIAGNOSTIC_CONTRACT_FINGERPRINT,
...
def acquisition_contract_manifest() -> dict[str, object]:
    ...
    payload: dict[str, object] = {
        ...
        "v6_observed_failure": {
            ...
            "ticker": "O:ARTC140719C00025000",
            "failure_class": (
                "UNVERSIONED_ADDITIONAL_UNDERLYINGS_PLUS_CFI_CONFLICT"
            ),
        },
        "accepted_diagnostics": {
            ...
            "artc_cash_deliverable_classification": {
                "contract_fingerprint": ARTC_DIAGNOSTIC_CONTRACT_FINGERPRINT,
                "evidence_fingerprint": ARTC_DIAGNOSTIC_EVIDENCE_FINGERPRINT,
                "current_target_rows": 2,
                "current_correction_values": [None],
                "current_cfi_values": ["OCASCN", "OCASPS"],
                "current_additional_underlyings": [
                    [{"amount": 4825, "type": "currency", "underlying": "USD"}],
                    None,
                ],
                "differing_fields": ["additional_underlyings", "cfi"],
                "historical_as_of_dates_with_exact_match": [
                    "2014-07-17",
                    "2014-07-18",
                ],
                "historical_target_rows": 1,
                "historical_overview_present": True,
                "historical_overview_matches_historical_list": True,
                "historical_payload_matches_exactly_one_current_row": True,
                "selected_provider_record_sha256": (
                    "6f1274868c60e6d23c42c96e4698a08724b3ff1014dd6ecf5b3a992f9794d3d8"
                ),
                "selected_cfi": "OCASCN",
                "selected_cash_additional_underlying_usd": 4825,
                "boundary_matrix_repeat_stable": True,
            },
        },
        "provider": "massive",
        ...
        "external_corroboration_only": {
            ...
            "artc": {
                "sources": [
                    "SEC_EDGAR_ARTHROCARE_2014_05_29_8K",
                    "SMITH_NEPHEW_2014_05_29_COMPLETION_RELEASE",
                    "ISO_10962_CFI_CLASSIFICATION_CONTEXT",
                ],
                "finding": (
                    "ArthroCare was acquired for 48.25 USD cash per common share; "
                    "100 shares imply 4825 USD, exactly matching the historical "
                    "Massive additional-underlying cash deliverable. The CFI change "
                    "co-moves with that cash/non-standardized representation."
                ),
                "used_by_runtime_resolver": False,
            },
        },
        ...
        "normalization": {
            ...
            "unversioned_cash_deliverable_classification_fallback": {
                "eligible_reference_state": "EXPIRED",
                "eligible_highest_correction_rank": -1,
                "required_differing_fields_exactly": list(
                    UNVERSIONED_DELIVERABLE_CFI_ALLOWED_DIFFERING_FIELDS
                ),
                "current_underlying_ticker_must_be_identical": True,
                "current_primary_exchange_must_be_identical": True,
                "current_shares_per_contract_must_be_identical": True,
                "one_current_payload_must_have_cash_additional_underlying": True,
                "one_current_payload_must_lack_additional_underlying": True,
                "historical_as_of": "expiration_date_minus_1_calendar_day",
                "historical_list": {
                    "endpoint": REFERENCE_ENDPOINT,
                    "underlying_filter": "OMITTED",
                ...
                "historical_list_and_overview_payload_must_match": True,
                "historical_payload_must_exactly_match_one_current_conflicting_payload": True,
                "historical_selected_payload_must_have_cash_additional_underlying": True,
                "dynamic_deliverable_authority_created": False,
                "otherwise": "FAIL_CLOSED",
                "policy": UNVERSIONED_DELIVERABLE_CFI_POLICY,
            },
        ...
        "reuse": {
            "verified_v7_receipts": True,
            "verified_v6_raw_lineage": True,
...
HISTORICAL_OPTION_REFERENCE_V7_CONTRACT_FINGERPRINT = _stable_hash(
