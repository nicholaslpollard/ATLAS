...
class MarketDataPaths:
    ...
    def forecast_horizon_clock_book_file(self) -> Path:
        root = self.settings.resolved_path(self.settings.data.paths.live)
        return (
            root
            / "simulation"
            / "forecast_horizon_clock_book"
            / "current.json"
        )
    ...
    def recurrent_time_aware_stock_close_evidence_file(self) -> Path:
        root = self.settings.resolved_path(self.settings.data.paths.live)
        return (
            root
            / "simulation"
            / "recurrent_time_aware_stock_close"
            / "current.json"
        )
