...
RECURRENT_ENTRY_FILL_CONTRACT = {
    "contract_id": "atlas-simulation-recurrent-entry-fill-evidence-v1",
    "scope": "PRODUCT_SIMULATION_RECURRENT_BROKER_NEUTRAL_COMPLETE_ENTRY_FILL_EVIDENCE",
    ...
    "exact_decision_and_candidate_lineage_required": True,
    ...
    "stock_quantity_derived_from_fill_price": True,
    "stock_funding_semantics_inferred": False,
    "option_terms_required": True,
    "option_contract_count_and_multiplier_exact": True,
    "option_cash_debit_includes_entry_fees": True,
...
RECURRENT_FUNDING_TERMS_CONTRACT = {
    "contract_id": "atlas-simulation-recurrent-funding-terms-v1",
    "scope": "PRODUCT_SIMULATION_RECURRENT_ENTRY_FUNDING_TERMS_ONLY",
    "inputs": [
    ...
    "stock_uses_reserved_capital_plus_current_unreserved_cash": True,
    ...
    "historical_fees_and_realized_pnl_not_recomputed": True,
    "descriptive_only": True,
...
RECURRENT_ENTRY_FILL_CONTRACT_FINGERPRINT = _fingerprint(
    RECURRENT_ENTRY_FILL_CONTRACT
)
RECURRENT_FUNDING_TERMS_CONTRACT_FINGERPRINT = _fingerprint(
    RECURRENT_FUNDING_TERMS_CONTRACT
)
