...
RECURRENT_EXIT_FILL_CONTRACT = {
    "contract_id": "atlas-simulation-recurrent-exit-fill-evidence-v1",
    "scope": "PRODUCT_SIMULATION_RECURRENT_BROKER_NEUTRAL_COMPLETE_EXIT_FILL_EVIDENCE",
    "input_account": "atlas-simulation-recurrent-lifecycle-account-v1",
    "exact_recurrent_state_fingerprint_required": True,
    "exact_active_open_position_fingerprint_required": True,
    "source_id_and_sha256_required": True,
    "timezone_aware_exit_timestamp_required": True,
    "exit_timestamp_not_before_account_state": True,
...
RECURRENT_EXIT_FILL_CONTRACT_FINGERPRINT = contract_fingerprint()
