...
SIMULATED_EXIT_FILL_CONTRACT = {
    ...
    "exit_timestamp_not_before_open_position_state": True,
    ...
    "gross_exit_proceeds": "quantity*exit_price_per_unit*contract_multiplier",
...
SIMULATED_EXIT_FILL_CONTRACT_FINGERPRINT = contract_fingerprint()
