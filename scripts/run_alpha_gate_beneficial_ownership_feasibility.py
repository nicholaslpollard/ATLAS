...
def main() -> int:
    print("ATLAS Pre-Phase33 Alpha Gate — SEC Schedule 13D/13G Beneficial Ownership Feasibility")
    print(f"Feasibility contract: {BENEFICIAL_OWNERSHIP_FEASIBILITY_CONTRACT}")
    print(f"Feasibility fingerprint: {beneficial_ownership_feasibility_fingerprint()}")
    print(f"Expected frozen fingerprint: {BENEFICIAL_OWNERSHIP_FEASIBILITY_FINGERPRINT}")
    ...
    print("PIT identity source: Massive /v3/reference/tickers exact subject-CIK/date active common stock")
    ...
    print(
        ...
        f"subject_cik_reconciled>={BENEFICIAL_OWNERSHIP_MIN_SUBJECT_CIK_RECONCILED}; "
    ...
    try:
        ...
        report = BeneficialOwnershipSourceFeasibility(
            settings,
        ...
        print("SEC beneficial-ownership source feasibility: NOT ACCEPTED")
        print(f"Reason: {exc}")
        print("No alpha hypothesis, Phase33 entry, protected read, or trading authority was granted.")
        return 2

    print()
    print(f"SEC beneficial-ownership source feasibility: {report['status']}")
    print(
    ...
    print(f"Subject CIK reconciled: {report['subject_cik_reconciled']}")
