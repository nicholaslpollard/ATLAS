...
text = text.replace(
    "and updates to both\nliving documents in the same accepted package.",
    "and updates to all applicable\nliving documents in the same accepted package.",
)
