...
roadmap = roadmap.replace('**eight genuinely new mechanisms**', '**nine genuinely new mechanisms**')
roadmap = roadmap.replace('**18-family practitioner library**', '**19-family practitioner library**')
...
register = replace_required(register,
